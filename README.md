# Blessen P Shaju — Personal Portfolio
...
- **Project Showcase & Modals**: Detailed problem-solved callouts and deep-dive modal dialogs for LARS and RigMasterAI.
- **Academic & Learning Roadmap**: Connectors adapt dynamically between horizontal (`→`) and vertical (`↓`) layouts across desktop, tablet, and mobile.
...
```bash
# Clone repository
git clone https://github.com/blessen5/portfoliowebsite.git
...
MIT © [Blessen P Shaju](https://github.com/blessen5)
